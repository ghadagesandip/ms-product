...
export default class ProductController extends BaseController {
    ...
    public async index(req:Request, res:Response): Promise<void> {
        try{
            ...
            const page: number = req.query && req.query.page ? parseInt(req.query.page as string) : 1
            const limit: number = req.query && req.query.limit ? parseInt(req.query.limit as string) : 10
